...
from middleware import (
    get_user_settings, get_machines, add_machines, add_machine_settings, 
    login_with_google, callback, update_setting, user, logout, get_user_machines
)
...
# ✅ Ensuring Flask runs with the correct port on Heroku
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 5001))  # Default to 5000 for local testing
    app = create_app()
    ...
    # flask --app app.py run --host=0.0.0.0 --port=5001 --debug=True